...
# Initialise
kws = KiteTicker("rcpm0qsa3tuuflu5", "eWZPQ3h89X7OYkPwsRjRRNH0FiAF2UTA")
...
def on_connect(ws, response):
    ...
    scrip = [16592386,16560642,16560898,16563202,16492034,16492802,16562690,16568066,16569346,16570626,16574210,16579074,16593666,16619522,\
    ...
    ws.set_mode(ws.MODE_FULL, [16592386])
    ws.set_mode(ws.MODE_FULL, [16592386])
