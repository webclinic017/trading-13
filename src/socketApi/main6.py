...
# data = kite.generate_session("Azgxe8HD09CRZqmNcZPXcWwzlRYX93b0", api_secret= api_secret)
# https://api.kite.trade/instruments
# https://kite.trade/connect/login?api_key=rcpm0qsa3tuuflu5&v=3

# access_token = "6HeAH4qvh0isfyu1xervWAs7vI7y4rF0"

kite.set_access_token("vE3MmeUfaaSfrvMs154UOYDguAJd7Q0A")
...
tokens = [58246663]
dict = {58246663: 'GOLDM21MAYFUT'}


def on_ticks(ws, ticks):
    #ticks = [dict[ticks[0]['instrument_token']], ticks[0]['timestamp'], ticks[0]['last_price']]
    #ticks = [dict[ticks[0]['instrument_token']]]
    #ticks = [dict[ticks[0]['instrument_token']], ticks[0]['volume'], ticks[0]['last_price']]
