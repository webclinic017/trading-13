...
sendMessage(ws, "quote_add_symbols", [session, "OANDA:XAUUSD", {"flags": ['force_permission']}])
sendMessage(ws, "quote_fast_symbols", [session, "OANDA:XAUUSD"])

# st='~m~140~m~{"m":"resolve_symbol","p":}'
# p1, p2 = filter_raw_message(st)
sendMessage(ws, "resolve_symbol", [chart_session, "symbol_1",
                                   "={\"symbol\":\"OANDA:XAUUSD\",\"adjustment\":\"splits\",\"session\":\"extended\"}"])
